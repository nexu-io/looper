...
// FormatIndex renders the prompt section that points the agent at required skills.
func FormatIndex(entries []Entry) string {
	var b strings.Builder
	b.WriteString("Review method skills:\n")
	b.WriteString("Required skills MUST be read from the given absolute paths before reviewing.\n")
