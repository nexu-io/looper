...
func TestBuildReviewPromptIncludesActionableQualityContract(t *testing.T) {
	...
	for _, want := range []string{
		...
		"<!-- looper:stamp v=1 -->",
		`<sub>Generated by <a href="https://github.com/nexu-io/looper">Looper</a> 0.0.0-dev — An autonomous AI dev team for your GitHub repos — plan, review, fix, and ship PRs, on a loop. · runner=reviewer · agent=opencode</sub>`,
