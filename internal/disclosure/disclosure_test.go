...
func TestMarkdownFooterIsIdempotent(t *testing.T) {
	...
	if !strings.Contains(second, `Generated by <a href="https://github.com/nexu-io/looper">Looper</a> 1.2.3 · runner=worker · agent=claude-code`) {
...
func TestMarkdownFooterLinksToLooperRepository(t *testing.T) {
	...
	if !strings.Contains(got, `Generated by <a href="https://github.com/nexu-io/looper">Looper</a> 1.2.3`) {
...
func TestDisclosureIncludesAgentVendorAndModelSeparately(t *testing.T) {
	...
	if !strings.Contains(footer, `Generated by <a href="https://github.com/nexu-io/looper">Looper</a> 1.2.3 · runner=worker · agent=opencode · model=openai/gpt-5.5`) {
