...
func TestMarkdownFooterIsIdempotent(t *testing.T) {
	...
	if !strings.Contains(second, "Generated by [Looper](https://github.com/powerformer/looper) 1.2.3 · runner=worker · agent=claude-code") {
		t.Fatalf("footer was not replaced: %q", second)
	}
}

func TestMarkdownFooterLinksLooperInline(t *testing.T) {
	s := testStamper()
	got := s.Markdown("Body", "worker", ChannelPullRequest)
	if !strings.Contains(got, "Generated by [Looper](https://github.com/powerformer/looper) 1.2.3") {
		t.Fatalf("footer missing inline repository link: %q", got)
	}
	if strings.Contains(got, "https://github.com/powerformer/looper\n") {
		t.Fatalf("footer included standalone repository link: %q", got)
	}
}
...
func TestDisclosureIncludesAgentVendorAndModelSeparately(t *testing.T) {
	...
	if !strings.Contains(footer, "Generated by [Looper](https://github.com/powerformer/looper) 1.2.3 · runner=worker · agent=opencode · model=openai/gpt-5.5") {
