...
func PromptInstruction(runner, branch, baseBranch string, expectPush, expectPR bool) string {
	...
	return strings.Join([]string{
		...
		fmt.Sprintf("Disclose looper-generated external content: keep commit subjects unchanged and add a commit body trailer like `Generated-By: looper %s (runner=%s, agent=<agent-runtime>)`; add this Markdown footer to generated PR/issue bodies or normal comments: `<!-- looper:stamp v=1 -->` followed by `<sub>Generated by looper %s · runner=%s · agent=<agent-runtime></sub>`. For inline review comments, use only the hidden `<!-- looper:stamp v=1 -->` marker unless a visible summary disclosure is appropriate. Do not include hostname, username, local paths, IP/MAC addresses, env vars, tokens, endpoints, or machine identifiers.", version.Current().Version, runner, version.Current().Version, runner),
