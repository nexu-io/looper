...
func containsVisibleInlineReviewDisclosure(body string) bool {
	return strings.Contains(body, "Generated by Looper") || strings.Contains(body, "Generated by "+disclosure.RepoLinkHTML) || strings.Contains(body, "Generated by [Looper]("+disclosure.RepoURL+")") || strings.Contains(body, "Generated by [Looper]("+disclosure.LegacyRepoURL+")")
}
